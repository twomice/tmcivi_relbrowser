 ...
 <div class="view-content">
  ...
  {if $action NEQ 1 AND $action NEQ 2 AND $permission EQ 'edit'}
        <div class="action-link">
            ...
            {l ref=viewRelationshipMap button=true caption="&raquo; View Map" args="cid=`$contactId`&reset=1"}
            {l ref=viewRelationshipList button=true caption="&raquo; View List" args="cid=`$contactId`&reset=1"}
        </div>
        <div class="clear"></div>
  {/if}
